        ...
        <div className='w-50 border bg-light p-5'>
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" name='Direccion' className='form-control' value={data.Direccion} onChange={e => setData({...data, Direccion: e.target.value})}/>
                </div>
                
                <div>
                    <label htmlFor="name">Telefono:</label>
                    <input type="text" name='Telefono' className='form-control' value={data.Telefono} onChange={e => setData({...data, Telefono: e.target.value})}/>
                </div>
                <br/>
